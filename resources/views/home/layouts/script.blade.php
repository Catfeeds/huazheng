@section('script')
    <script type="text/javascript" src="{{ asset('resources/home/js/common.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('resources/home/js/layer.js') }}"></script>
    <script type="text/javascript" src="{{ asset('resources/home/js/ckplayer/ckplayer.js') }}"></script>
    <script type="text/javascript" src="{{ asset('resources/home/js/cropper.js') }}"></script>
@show